...
**当前阶段：M0 脚手架完成；M1 进行中——core 统一类型/异常/SPI、provider-openai、provider-anthropic、成本计算与 Token 计数已落地（含 WireMock 测试）。**
...
litellm-core (统一 OpenAI 格式类型)
   ▲
litellm-providers (OpenAI / Anthropic / Azure / Gemini / Bedrock / Mistral, SPI 可扩展)
   ▲
